...
const Carousel: FC<CarouselProps> = ({ slice }) => {
  ...
  return (
    <section
      ...
      className="carousel relative flex h-screen flex-col justify-between overflow-hidden bg-white py-12 text-white"
    >
      ...
      <div className="flex w-full flex-row items-center justify-center p-4">
        ...
        <View className="aspect-square h-[70vmin] min-h-40" >
          ...
          <Environment preset="lobby" environmentIntensity={0.6} environmentRotation={[0, 3, 0]} />
